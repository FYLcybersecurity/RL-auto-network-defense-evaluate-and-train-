...
from CybORG.Agents.SimpleAgents.RedFeiyang import RedFeiyangAgent
...
randomagents = [B_lineAgent, RedMeanderAgent, RedFeiyangAgent]
...
if __name__ == "__main__":
    ...
    for num_steps in [100]:
        ...
        for i in range(MAX_EPS):
            ...
            #agent.reset()
        print(f'Average reward vs random (P=1/3) red agent and steps {num_steps} is: {mean(total_reward)} with a standard deviation of {stdev(total_reward)}')
        with open(file_name, 'a+') as data:
